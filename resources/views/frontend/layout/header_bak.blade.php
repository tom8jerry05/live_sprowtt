        ...
        <nav class="navbar navbar-inverse navbar-fixed-top sprowttnavbar" role="navigation">
                            ...
                            <div class="clslearnhow">
                                ...
                                <div class="learnleftblock">
                                    ...
                                    <span style="display: none;"> 
                                        ...
                                        <a href="{{ route('SampleChallages') }}"> 

                                            <img src="{{ asset('frontend/images/right-arrow-icon.png') }}">Challenges grid
            ...
            <div class="col-md-2 sp-btn-link-area">
                ...
                @guest
                    ...
                    <a href="{{ route('login') }}" class="btn btn-link white-outline pull-right">Log In</a>

                @else

                    <a href="{{ route('dashboard') }}" class="btn btn-link white-outline pull-right">Dashboard</a>
